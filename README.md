...
- ¿Cómo decidió las opciones técnicas y arquitectónicas utilizadas como parte de su solución?
  Basándome en un antiguo proyecto que imita la página G
  iphy
- ¿Hay alguna mejora que pueda hacer en su envío?
  Si
- ¿Qué haría de manera diferente si se le asignara más tiempo?
  Terminaría toda la aplicacion con calma, dedicaría el tiempo a tener la maquetación y luego usaría contexto y promesas para obtener los datos del JSON y e intentaría hacer la aplicación completamente funcional.
